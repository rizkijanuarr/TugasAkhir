...
const PermissionIndex = lazy(() => import("../views/Permissions/Index.jsx"));

//import view permissions create
const PermissionCreate = lazy(() => import("../views/Permissions/Create.jsx"));

//import view permissions edit
const PermissionEdit = lazy(() => import("../views/Permissions/Edit.jsx"));
...
export default function RoutesIndex() {
  return (
    <Routes>
      ...
      {/* private route "/permissions/create" */}
      <Route
      ...
      {/* private route "/permissions/edit/:id" */}
      <Route
