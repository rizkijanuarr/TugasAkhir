...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        ->middleware('permission:permissions.index|permissions.store|permissions.update|permissions.delete');
...
Route::group(['middleware' => 'auth:api'], function() {
    ...
    Route::post('/feedback', [App\Http\Controllers\Api\Public\FeedbackController::class, 'store']);
